...
U 1 1 5F854DB2
P 4850 5550
F 0 "C5" H 4965 5596 50  0000 L CNN
F 1 "1uF" H 4965 5505 50  0000 L CNN
F 2 "Capacitor_THT:CP_Radial_D5.0mm_P2.50mm" H 4888 5400 50  0001 C CNN
...
F 2 "Resistor_THT:R_Axial_DIN0204_L3.6mm_D1.6mm_P7.62mm_Horizontal" V 4780 5000 50  0001 C CNN
...
U 1 1 5F856A3C
P 4600 5950
F 0 "#PWR013" H 4600 5700 50  0001 C CNN
...
F 1 "VCC" H 4867 4923 50  0000 C CNN
...
U 1 1 5F855E91
P 4250 5550
F 0 "SW1" V 4296 5502 50  0000 R CNN
F 1 "RESET" V 4205 5502 50  0000 R CNN
F 2 "Button_Switch_THT:SW_PUSH_6mm" H 4250 5750 50  0001 C CNN
...
Watch out !!!! \nThere is an ERROR in v1.0 of the schematic and PCB,\n ~A15~ should be marked as A15 on the diagram... \nthe result is that A15 on the CPU is not connected to the JP3 or U1D. \nFixed  with a short wire link on the PCB. Fixed in version 1.1
