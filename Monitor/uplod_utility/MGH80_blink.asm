PIO_A	EQU	00h		; CA80 user 8255 base address 	  (port A)
PIO_B	EQU	01h		; CA80 user 8255 base address + 1 (port B)
PIO_C	EQU	02h		; CA80 user 8255 base address + 2 (port C)
PIO_M	EQU	03h		; CA80 user 8255 control register
